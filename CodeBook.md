Data used in this assignment was collected from the accelerometers from the Samsung Galaxy S smartphone.
...
For the purpose of this assignment, only mean and standard deviation variables were required from x. So the data was
reduced to only contain these variables along with their respective y label and subject for each observation.
